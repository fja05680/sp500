...
##### Historical Lists of S&P 500 components since 1996: `S&P 500 Historical Components & Changes(02-16-2020).csv`
##### Example code to retrieve a snapshot of the S&P 500 components on a certain date: `sp500_by_date.ipynb`

### Description of Files

- `S&P 500 Historical Components & Changes(02-16-2020).csv`: contains historical S&P 500 index membership from 1996 til 12-16-2019.  Output from 'sp500_historical.ipynb' 
